...
class RefDes(unittest.TestCase):
    def test_refdes(self):
        ...
        for spath, seg_id, qual, eleidx, subeleidx in tests:
            ...
            self.assertEqual(
                rd.subele_idx, subeleidx, "%s: %s != %s" % (spath, rd.subele_idx, subeleidx)
            )
...
class IsChild(unittest.TestCase):
    def testChildLoopOK1(self):
        ...
        self.assertTrue(
            parent.is_child_path("/ISA_LOOP/GS_LOOP/ST_LOOP/DETAIL/2000A/2000B/2300/2400/SV2")
        )
    ...
    def testChildLoopOK2(self):
        ...
        parent = pyx12.path.X12Path(path_str)
        self.assertTrue(
            parent.is_child_path("/ISA_LOOP/GS_LOOP/ST_LOOP/DETAIL/2000A/2000B/2300/2400/2500/ASD")
        )
    ...
    def testLoopSegSame1(self):
        ...
        parent = pyx12.path.X12Path(path_str)
        self.assertFalse(
            parent.is_child_path("/ISA_LOOP/GS_LOOP/ST_LOOP/DETAIL/2000A/2000B/2300/2400")
        )
