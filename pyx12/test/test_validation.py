...
class BasicString(unittest.TestCase):
    def testValid(self):
        ...
        self.assertTrue(
            IsValidDataType(
                r"""BASIC ABCDEFIGHIJKLMNOPQRSTUVWXYZ 0123456789!"&'()+,-./;:?=""", "AN", "B"
            )
        )
    ...
    def testInvalid(self):
        ...
        self.assertFalse(
            IsValidDataType(r"extended abcdefghijklmnopqrstuvwxyz%~@[]_{}\|<>#$", "AN", "B")
        )
        self.assertFalse(
            IsValidDataType(
...
class ExtendedString(unittest.TestCase):
    def testValid(self):
        ...
        self.assertTrue(
            IsValidDataType(
                """BASIC ABCDEFIGHIJKLMNOPQRSTUVWXYZ 0123456789!"&'()+,-./;:?=""", "AN", "E"
            )
        )
        self.assertTrue(
            IsValidDataType(r"extended abcdefghijklmnopqrstuvwxyz%~@[]_{}\|<>#$", "AN", "E")
        )
        self.assertTrue(
            IsValidDataType(
                r"""Both ABCDEFIGHIJKLMNOPQRSTUVWXYZ 0123456789!"&'()+,-./;:?= abcdefghijklmnopqrstuvwxyz%~@[]_{}\|<>#$""",
...
class Extendedi5010Identifier(unittest.TestCase):
    ...
    def testInvalid(self):
        self.assertFalse(IsValidDataType("%s" % (chr(0x1D)), "ID", "E", "00501"))
...
class Extended5010String(unittest.TestCase):
    def testValid(self):
        ...
        self.assertTrue(
            IsValidDataType(
                r"extended abcdefghijklmnopqrstuvwxyz%~@[]_{}\|<>#$", "AN", "E", "00501"
            )
        )
        self.assertTrue(
            IsValidDataType(
