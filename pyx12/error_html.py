...
class error_html:
    ...
    def header(self) -> None:
        ...
        self.fd.write(
            "  span.error { background-color: #CCCCFF; color: red; font-style: normal; }\n"
        )
        self.fd.write("  span.info { color: blue; font-style: normal; }\n")
        self.fd.write(
            "  span.ele_err { background-color: yellow; color: red; font-style: normal; }\n"
        )
        self.fd.write("  -->\n</style>\n")
        self.fd.write('  <link rel="stylesheet" href="errors.css" type="text/css" />\n')
        self.fd.write("</head>\n<body>\n")
        self.fd.write(
            "<h1>X12N Error Analysis</h1>\n<h3>Analysis Date: %s</h3><p>\n"
